...
awful.spawn.once("chromium --restore-last-session --unsafely-treat-insecure-origin-as-secure=http://chat01.ihu.mecel.net", { floating = false, screen = function() return screen.count() > 1 and 2 or 1 end, tag = "2" } )
...
awful.spawn.once("mount /home/jimmieh/ihu/aosp_local/out", {} )
awful.spawn.once("mount /home/jimmieh/sem/aosp_local/out", {} )
